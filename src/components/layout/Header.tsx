...
const logoClassName =
  'block h-auto w-[255px] max-w-[min(255px,calc(100vw-5rem))] sm:max-w-none';
  ...
  return (
    <header className={`overflow-visible bg-yellow-500 ${isInternal ? 'shadow-sm' : ''}`}>
      <div className={barOuterClass}>
        ...
        <AppLink to="/" aria-label="Ir para início" className="relative z-0 mt-5 flex shrink-0 self-start overflow-visible">
          <img
            src={logoHeader}
            alt="Max Maciel"
