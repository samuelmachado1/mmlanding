...
function iconClassName(platform: SocialPlatform, className: string) {
  return [platformColorClasses[platform], className].filter(Boolean).join(' ');
}
...
export function SocialIcon({ platform, className = 'h-5 w-5' }: SocialIconProps) {
  switch (platform) {
    case 'instagram':
      return (
        <svg {...svgProps} className={iconClassName(platform, className)}>
